...
firstname='Nishantraj'                        #Add your LastName
lastname='Pandey'                         #Add your FirstName
joblink=[]                          #Initialized list to store links
maxcount=50                         #Max daily apply quota for Naukri
keywords=['Project Manager','Supply chain']                    #Add you list of role you want to apply
...
try:
    profile = webdriver.FirefoxProfile("C:/Users/nisha/AppData/Roaming/Mozilla/Firefox/Profiles/eby79nuz.Nishant") #Add your Root directory path
...
for k in keywords:
    for i in range(2):
        if location=='':
            url = "https://www.naukri.com/"+k.lower().replace(' ','-')+"-jobs?k="+k.lower()
